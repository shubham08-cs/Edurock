...
<head>
    ...
    <title>Home 2 | Edurock - Education LMS Template</title>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-12" data-aos="fade-up">
                        <div class="educationarea__right__wraper" data-tilt>
                            <div class="educationarea__img">
                                <img loading="lazy"  class="education__img__1" src="img/education/education.png" alt="education">
                                <img loading="lazy"  class="education__img__2" src="img/education/education__1.png" alt="education">
                                <img loading="lazy"  class="education__img__3" src="img/education/education__2.png" alt="education">
                                <img loading="lazy"  class="education__img__4" src="img/education/education__3.png" alt="education">
                            </div>
                            <div class="educationarea__small__img">
                                <a href="#">
                                    <img loading="lazy"  class="education__img__5" src="img/education/education__4.png" alt="education">
                                    <img loading="lazy"  class="education__img__6" src="img/education/education__5.png" alt="education">
                                    <img loading="lazy"  class="education__img__7" src="img/education/education__6.png" alt="education">
                                    <img loading="lazy"  class="education__img__8" src="img/education/education__7.png" alt="education">
                                </a>
                            ...
                            <div class="educationarea__small__img__2">
                                <img loading="lazy"  src="img/about/about_16.png" alt="educator">
                ...
                <div class="row populerarea__wraper" data-aos="fade-up">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="populerarea__button">
                            <a class="default__button" href="course.php">All Catagories
                                <i class="icofont-long-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="registerarea__content">
                                <div class="registerarea__video">
                                    <div class="video__pop__btn">
                                        <a class="video-btn" href="https://www.youtube.com/watch?v=vHdclsdkp28"> <img loading="lazy" 
                                ...
                                <div class="eventarea__content__wraper">
                                    <div class="eventarea__list">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="instructor-details.php">Mirnsdo .H</a> - Event Speaker
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="single__event__heading">
                                        <h4><a href="event-details.php">Forging relationships between multi to national
