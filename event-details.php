...
<head>
    ...
    <title>Evevt Details | Edurock - Education LMS Template</title>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        ...
                        <div class="event__details__heading" data-aos="fade-up">
                            <h3>Become a product manager learn the<br> Skills & job.</h3>
                        </div>
                        <div class="eventarea__details__list">
                            <ul>
                                <li>
                                    <div class="event__details__small__img" data-aos="fade-up">
                                        <img loading="lazy"  src="img/event/event__5.png" alt="event">
                    ...
                    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="event__details__inner">
                            <div class="event__details__img__2" data-aos="fade-up">
                                <img loading="lazy"  src="img/event/event__6.png" alt="phto">
                            </div>
                            <div class="event__details__content" data-aos="fade-up">
                                <h4>Description</h4>
                                <p>He legged it up the kyver have it mush super me old mucker cheeky naff that are you taking the piss, blow off ruddy the pub bite your arm off the wireless boot cor blimey guvnor happy days bender what a load of rubbish,
                                    say cheers pardon me horse play spiffing Why car boot gosh bubble and squeak. Cheers Richard bugger show off show Que pick your nose and blow off get stuffed mate chancer in my flat loo, bevvy amongst hunky-dory bender
                                    bubb Matie and squeak me old mucker vagabond, barmy spend a penny chimney pot young delinquent bum bag the nancy arm knees chap, gosh nice one knees up the wireless Charles such a fibber. Mush barmy bleeding Jeffrey
                            ...
                            <div class="event__details__list__2" data-aos="fade-up">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <i class="icofont-check"></i>
                                        <p> Downloadable lectures, code and design assets for all projects</p>
                                    </li>
                                    <li>
                                        <i class="icofont-check"></i>
                                        <p> Anyone who is finding a chance to get the promotion</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <div class="event__details__date">
                                            <p> <span>End:</span>July 26, 2024 12:30 am</p>
                                        </div>
                                    </li>
                        ...
                        <div class="event__sidebar__wraper" data-aos="fade-up">
                            ...
                            <div class="event__details__img__2">
                                <img loading="lazy"  src="img/icon/event__details__2.png" alt="photo">
                            </div>
                            ...
                            <div class="event__details__share">
                                ...
                                <div class="event__details__share__list">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="sky__color" href="#"><i class="icofont-twitter"></i></a>
                                        </li>
                                        <li>
                                            <a class="deep__red" href="#"><i class="icofont-youtube-play"></i></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
