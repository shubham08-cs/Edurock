...
<head>
    ...
    <title>Home-7 University Dark | Edurock - Education LMS Template</title>
        ...
        <div class="herobannerarea herobannerarea__2 herobannerarea__university">
            ...
            <div class="swiper university__slider">
                ...
                <div class="herobannerarea__slider__wrap swiper-wrapper">
                    ...
                    <div class="swiper-slide herobannerarea__single__slider" style="background: url(img/herobanner/university_1.jpg);">
                        <div class="container">
                    ...
                    <div class="swiper-slide herobannerarea__single__slider" style="background: url(img/herobanner/university_2.jpg);">
                        <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__content__wraper text-center">
                    ...
                    <div class="swiper-slide herobannerarea__single__slider" style="background: url(img/herobanner/university_3.jpg);">
                        <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__content__wraper text-center">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        ...
                        <div class="best__categories__item aos-init" data-aos="fade-up">
                            <a class="best__categories__link" href="course.php">
                            ...
                            <div class="col-xl-12">
                                <div class="aboutarea__content__tap__wraper">
                                    <p class="paragraph__1">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words look even slightly believable. If you are going to use
                                        ...
                                        <img loading="lazy"  src="img/about/overview.jpg" alt="">
                                </div>
                        ...
                        <div class="social__wrapper">
                            <div class="single__event__wraper" data-aos="fade-up">
                                ...
                                <div class="eventarea__content__wraper">
                                    ...
                                    <div class="single__event__heading">
                                        <h4><a href="event-details.php">Forging relationships between multi to national governments and global.</a></h4>
                                    </div>
                                    <div class="single__event__button">
                                        <a href="event-details.php">Read More <i class="icofont-simple-right"></i></a>
                                    </div>
