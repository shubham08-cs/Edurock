...
<head>
    ...
    <title>About Dark | Edurock - Education LMS Template</title>
                    ...
                    <div class="aboutarea__content__wraper__5">
                        ...
                        <div class="aboutarea__para__5">
                            <p>I love to work in User Experience & User Interface designing. Because I love to solve the
                                ...
                                make good user interface with the best user
            ...
            <div class="row">
                <div class="col-xl-12" data-aos="fade-up">
                    <ul class="nav  about__button__wrap" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="single__tab__link active" data-bs-toggle="tab"
                                    data-bs-target="#projects__one" type="button">About
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade active show" id="projects__one" role="tabpanel"
                        ...
                        <div class="col-xl-12">
                            <div class="aboutarea__content__tap__wraper">
                                <p class="paragraph__1">There are many variations of passages of Lorem Ipsum available,
                    ...
                    <div class="tab-pane fade" id="projects__two" role="tabpanel" aria-labelledby="projects__two">
                        ...
                        <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.php">Become a product Manager learn the
                                            skills & job.
                                        </a></h3>
                                </div>
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <div class="gridarea__details">
                                        <a href="course-details.php">Know Details
                        ...
                        <div class="gridarea__wraper gridarea__wraper__2 gridarea__course__list" data-aos="fade-up">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.php">Strategy law and with for organization
                                            Foundation
                                        </a></h3>
                                </div>
                                <div class="gridarea__price">
                                ...
                                <div class="row">
                                        ...
                                        <div class="single__event__wraper single__award" data-aos="fade-up">
                                            ...
                                            <div class="eventarea__content__wraper">
                                                <div class="single__event__heading">
                                                    <h4><a href="event-details.php">Forging relationships between
                                                            national</a></h4>
                                                </div>
                                                <div class="single__event__button">
                                                    <a href="event-details.php">Read More <i
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="single__event__wraper single__award" data-aos="fade-up">
                                            ...
                                            <div class="eventarea__content__wraper">
                                                <div class="single__event__heading">
                                                    <h4><a href="event-details.php">Lorem ipsum dolor sit amet conse
                                                            ctetur.</a></h4>
                                                </div>
                                                <div class="single__event__button">
                                                    <a href="event-details.php">Read More <i
                ...
                <div class="col-xl-6 column__custom__class">
                    <div class="single__testimonial__wraper">
                        ...
                        <div class="testimonial__content">
                            <p>The other hand we denounce with righteou indg ation men who are so beguiled and demoraliz
                                ed by the of the mo ment.Dislike men who are so beguiled and dems ed by the charms of
                                pleas ure of the moment. Lorem </p>
                        </div>
