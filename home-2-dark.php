...
<head>
    ...
    <title>Home 2 Dark | Edurock - Education LMS Template</title>
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="headerarea__left">
                                <div class="headerarea__left__logo">
                                    ...
                                    <a href="index.php"><img loading="lazy"  src="img/logo/logo_2.png" alt="logo"></a>
                                </div>
                        ...
                        <div class="col-xl-7 col-lg-7 main_menu_wrap">
                            ...
                            <div class="headerarea__main__menu">
                                <nav>
                                    <ul>
                                        <li><a class="headerarea__has__dropdown" href="index.php">Home
                                        <i class="icofont-rounded-down"></i></a>
                                            <ul class="headerarea__submenu ">
                                                <li><a href="index.php">Home Style 1</a></li>
                                                <li><a href="index-dark.php">Home 1 (Dark)</a></li>
                                                <li><a href="home-2.php">Home Style 2</a></li>
                                                <li><a href="home-2-dark.php">Home 2 (Dark)</a></li>
                                                <li><a href="home-3.php">Home Style 3</a></li>
                                                <li><a href="home-3-dark.php">Home 3 (Dark)</a></li>
                                            </ul>
                                        </li>

                                        <li><a class="headerarea__has__dropdown" href="about.php">About
                                      
                                    </a>

                                        </li>
                                        <li><a class="headerarea__has__dropdown" href="blog.php">Blog
                                        ...
                                        <li><a class="headerarea__has__dropdown" href="course.php">Course
                                        <i class="icofont-rounded-down"></i>
                                    </a>
                                            <ul class="headerarea__submenu">
                                                <li><a href="course.php">Course</a></li>
                                                <li><a href="course-dark.php">Course (Dark)</a></li>
                                                ...
                                                <li><a href="course-details-dark.php">Details (Dark)</a></li>
                                                <li><a href="course-details-2.php">Details 2</a></li>
                                                <li><a href="course-details-2-dark.php">Details 2 (Dark)</a></li>
                                                <li><a href="course-details-3.php">Details 3</a></li>
                                                <li><a href="course-details-3-dark.php">Details 3 (Dark)</a></li>
                                            </ul>
                                        </li>


                                        <li><a class="headerarea__has__dropdown" href="about.php">Pages
                                        <i class="icofont-rounded-down"></i>
                                    </a>
                                            <ul class="headerarea__submenu">
                                                <li><a href="about.php">About</a></li>
                                                <li><a href="about-dark.php">About (Dark)</a></li>
                                                ...
                                                <li><a href="instructor-details-dark.php">Details (Dark)</a></li>
                                                <li><a href="event-details.php">Event-Details</a></li>
                                                <li><a href="event-details-dark.php">Details (Dark)</a></li>
                    ...
                    <div class="row align-items-center">
                        <div class="col-6">
                            <div class="mobile-logo">
                                <a class="logo__dark" href="#"><img loading="lazy"  src="img/logo/logo_2.png" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-6">
                    ...
                    <div class="mobile-navigation">
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                ...
                                <li class="menu-item-has-children"><a href="portfolio.php">blog</a>
                                    <ul class="dropdown">
                                        <li><a href="blog.php">Blog</a></li>
                                        <li><a href="blog-dark.php">Blog (Dark)</a></li>
                                        <li><a href="blog-details.php">Blog-details</a></li>
                                ...
                                <li class="menu-item-has-children "><a href="instructor.php">Pages</a>
                                    <ul class="dropdown">
                                        <li><a href="about.php">About</a></li>
                                        <li><a href="about-dark.php">About (Dark)</a></li>
                                        <li><a href="contact.php">Contact</a></li>
                                ...
                                <li><a class="menu-item-has-children" href="contact.php">Contact</a></li>
                            </ul>
                        </nav>
