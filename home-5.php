...
<li><a href="dashboard/student-message.php">Message</a></li>
                ...
                <div class="row">
                        ...
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__title">
                                ...
                                <div class="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                                    <h2>Ignite Your <span>Career</span> with Industry-Focused <span>IT Training</h2>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="herobanner__video registerarea__video">
                            <img loading="lazy"  src="img/herobanner/herobanner__video.jpg" alt="Video Banner">
        ...
        <div class="gridarea__2 sp_bottom_100 sp_top_20" data-aos="fade-up">
            <!-- <div class="container-fluid full__width__padding">
                    ...
                    <div class="swiper featured__course">
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_9.png" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge">Data & Tech</div>
                                        </div>
                                        <div class="gridarea__small__icon">
