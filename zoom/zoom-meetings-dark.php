...
<head>
    ...
    <title>Zoom Meetings-Dark | Edurock - Education LMS Template</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        ...
                                                        <ul class="mega__menu__item">
                                                            ...
                                                            <li><a href="zoom-meetings.php">Zoom<span class="mega__menu__label">Online Call</span></a></li>
                                                            <li><a href="zoom-meetings-dark.php">Zoom Meeting (Dark)</a></li>
                                                            <li><a href="zoom-meeting-details.php">Zoom Meeting Details</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Get Started 3</a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="zoom-meeting-details-dark.php">Meeting Details (Dark)</a></li>
                                ...
                                <li class="menu-item-has-children "><a href="#">Pages</a>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="dropdown">
                                                <li><a href="zoom-meeting-details-dark.php">Meeting Details (Dark)</a>
                                                </li>
                                                <li><a href="/login.php">Login</a></li>
                                                <li><a href="/login-dark.php">Login (Dark)</a></li>
                                                <li><a href="maintenance.php">Maintenance</a></li>
...
<li><a href="/dashboard/student-message.php">Message</a></li>
                    ...
                    <div class="col-xl-12">
                        <div class="breadcrumb__content__wraper" data-aos="fade-up">
                            <div class="breadcrumb__title">
                                <h2 class="heading">Zoom Meetings</h2>
                            </div>
		...
		<div class="zoom__meetings sp_top_100 sp_bottom_70">
		    <div class="container-fluid full__width__padding">
		        <div class="row">

		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid ">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/1.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge">Development</div>
		                        </div>
		                    ...
		                    <div class="gridarea__content ">
		                        <div class="gridarea__list">
		                            <ul>
		                                <li>
		                                    <i class="icofont-calendar"></i> Dec 22,2024
		                                </li>
		                                <li>
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Executive Assistant Meeting</a></h3>
		                        </div>
		                        ...
		                        <div class="zoom__meeting__time__id">
		                            ...
		                            <div class="zoom__meeting__id">
		                                <p>Meeting ID :<span>952428993687</span></p>
		                            </div>
		                        </div>
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/2.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge blue__color">Managing</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        <div class="gridarea__list">
		                            <ul>
		                                <li>
		                                    <i class="icofont-calendar"></i> Dec 25,2024
		                                </li>
		                                <li>
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Website Renovation Meeting</a></h3>
		                        </div>
		                        ...
		                        <div class="zoom__meeting__time__id">
		                            ...
		                            <div class="zoom__meeting__id">
		                                <p>Meeting ID :<span>952429936777</span></p>
		                            </div>
		                        </div>
		                        <div class="gridarea__bottom">
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/3.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge green__color">Marketing</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        <div class="gridarea__list">
		                            <ul>
		                                <li>
		                                    <i class="icofont-calendar"></i> Dec 29,2024
		                                </li>
		                                <li>
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Marketing Committee Meeting</a></h3>
		                        </div>
		                        <div class="zoom__meeting__time__id">
                                    <div class="zoom__meeting__time">  
                                        <p>
		                            ...
		                            <div class="zoom__meeting__id">
		                                <p>Meeting ID :<span>952428993999</span></p>
		                            </div>
		                        </div>
		                        <div class="gridarea__bottom">
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/4.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge yellow__color">Leading</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Teacher Leader Team Meeting</a></h3>
		                        </div>
		                        <div class="zoom__meeting__time__id">
                                    <div class="zoom__meeting__time">  
                                        <p>
		                            ...
		                            <div class="zoom__meeting__id">
		                                <p>Meeting ID :<span>952428993555</span></p>
		                            </div>
		                        </div>
		                        <div class="gridarea__bottom">
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/5.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge">Responsibilities</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        <div class="gridarea__list">
		                            <ul>
		                                <li>
		                                    <i class="icofont-calendar"></i> Dec 30,2024
		                                </li>
		                                <li>
		                                    <i class="icofont-clock-time"></i> 2 hr 00 min
		                                </li>
		                            </ul>
		                        </div>
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Team member responsibilities</a></h3>
		                        </div>
		                        <div class="zoom__meeting__time__id">
                                    <div class="zoom__meeting__time">  
                                        <p>
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/6.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge blue__color">Planning</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Strategic Planning Meeting</a></h3>
		                        </div>
		                        <div class="zoom__meeting__time__id">
                                    <div class="zoom__meeting__time">  
                                        <p>
		                            ...
		                            <div class="zoom__meeting__id">
		                                <p>Meeting ID :<span>952428993688</span></p>
		                            </div>
		                        </div>
		                        <div class="gridarea__bottom">
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/7.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge green__color">Cultural</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Student Committee Meeting</a></h3>
		                        </div>
		                        <div class="zoom__meeting__time__id">
                                    <div class="zoom__meeting__time">  
                                        <p>
		            ...
		            <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-up">
		                <div class="gridarea__wraper gridarea__wraper__2 zoom__meeting__grid">
		                    <div class="gridarea__img">
		                        <a href="zoom-meeting-details.php"><img loading="lazy"  src="../img/zoom/8.jpg" alt="grid"></a>
		                        <div class="gridarea__small__button">
		                            <div class="grid__badge yellow__color">Business</div>
		                        </div>
		                        <div class="gridarea__small__icon">
		                            <a href="#"><i class="icofont-heart-alt"></i></a>
		                        </div>
		                    ...
		                    <div class="gridarea__content">
		                        ...
		                        <div class="gridarea__heading">
		                            <h3><a href="zoom-meeting-details.php">Business Leader Team Meeting</a></h3>
		                        </div>
		                        <div class="zoom__meeting__time__id">
                                    <div class="zoom__meeting__time">  
                                        <p>
		                            ...
		                            <div class="zoom__meeting__id">
		                                <p>Meeting ID :<span>952428993698</span></p>
		                            </div>
		                        </div>
		                        <div class="gridarea__bottom">
