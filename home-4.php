...
<body class="body__wrapper">
    ...
    <div id="back__preloader">
        <div id="back__circle_loader"></div>
            <div class="back__loader_logo">
                <img loading="lazy"  src="img/logo.png" alt="Preload">
            </div>
        </div>
    </div>
    <!-- pre loader area end -->
    ...
    <main class="main_wrapper overflow-hidden">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__left">
                            <ul>
                                <li>
                                    Call Us: +91 8668769025
                                </li>
                                <li>
                                    - Mail Us: futuremind.infotech@gmail.com
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6">
                        <div class="topbar__right">
                            ...
                            <div class="topbar__text">
                                <p>Sujata co op socity City, Badlapur west</p>
                            </div>
        ...
        <header>
            <div class="headerarea   header__sticky header__area">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="headerarea__left">
                                <div class="headerarea__left__logo">
                                    ...
                                    <a href="index.php"><img loading="lazy" width="200"  src="img/logo.png" alt="logo"></a>
                                </div>
                                            ...
                                            <div class="headerarea__submenu mega__menu__wrapper">
                                                ...
                                                <div class="row">
                                                    <div class="col-4 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">IT & Software Development </a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="course.php"> Full Stack Development <span class="mega__menu__label">Java /Python / Dot.Net</span></a></li>
                                                            <li><a href="course-dark.php">Frontend Development (React / Angular)</a></li>
                                                            <li><a href="course-grid.php">Backend Development (Java / .NET / Node.js)</a></li>
                                                            <li><a href="course-grid-dark.php">Mobile App Development (Android / iOS / Flutter / React Native)</a></li>
                                                            <!-- <li><a href="course-list.php">Python Programming</a></li> -->
                                                            <li><a href="course-list-dark.php">C / C++ Programming</a></li>
                                                            <li><a href="course-list-dark.php">Cloud Computing (AWS / Azure / GCP)</a></li>
                                                            <li><a href="course-list-dark.php">Data Science & Analytics</a></li>
                                                            <li><a href="course-list-dark.php">Artificial Intelligence (AI) & Machine Learning (ML)</a></li>
                                                            <li><a href="course-list-dark.php">Cyber Security & Ethical Hacking</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-4 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Accounting, ERP & Professional Skills </a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="course-details.php">Tally Prime</a></li>
                                                            <li><a href="course-details-dark.php">Tally ERP Prime</a></li>
                                                            <li><a href="course-details-2.php">SAP (FI, MM, SD, HCM, ABAP etc.)</a></li>
                                                            <li><a href="course-details-2-dark.php">Advanced Excel</a></li>
                                                            <li><a href="course-details-3.php">GST Training</a></li>
                                                            <li><a href="course-details-3.php">Microsoft Office (Word, Excel, PowerPoint)</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-4 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Engineering, Design & Multimedia</a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="dashboard/become-an-instructor.php">Civil Engineering Software</a>
                                                            <li><a href="dashboard/create-course.php">CAD & Mechanical Design <span class="mega__menu__label">Career</span></a></li>
                                                            <li><a href="instructor.php">Graphic Designing</a></li>
                                                            <li><a href="instructor-dark.php">UI/UX Designing</a></li>
                                                            <li><a href="instructor-details.php">2D Or 3D Animation & VFX</a></li>
                        ...
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="herobannerarea__title">
                                ...
                                <div class="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                                    <h2>Ignite Your <span>Career</span> with Industry-Focused <span>IT Training </span>.</h2>
                                </div>
                            </div>


                            <div class="herobannerarea__text herobannerarea__text__2">
                                <p>Transform your future with our advanced software training programs designed for students, professionals, and career changers.<br>  We provide practical, hands-on learning with expert guidance to help you master the latest technologies </p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-8 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="swiper hero__course">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide gridarea__wraper gridarea__wraper__2">
                                    <div class="gridarea__img">
                                        ...
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge">Devlopment</div>
                                        </div>
                                    ...
                                    <div class="gridarea__content">
                                        <div class="gridarea__list">
                                            <ul>
                                                <li>
                                                    <i class="icofont-book-alt"></i> 94 Lesson
                                                </li>
                                                <li>
                                                    <i class="icofont-clock-time"></i> 5 to 6 months
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="gridarea__heading">
                                            <h3><a href="course-details.php">Full Stack Devlopment</a></h3>
                                        </div>
                                        <p>Master both front-end and back-end technologies to become a complete Full Stack Developer.</p>
                                ...
                                <div class="swiper-slide gridarea__wraper gridarea__wraper__2">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_2.png" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge blue__color">Data science</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                            <a href="#"><i class="icofont-heart-alt"></i></a>
                                        </div>
                                    ...
                                    <div class="gridarea__content">
                                        <div class="gridarea__list">
                                            <ul>
                                                <li>
                                                    <i class="icofont-book-alt"></i> 61 Lesson
                                                </li>
                                                <li>
                                                    <i class="icofont-clock-time"></i> 5 to 6 months
                                                </li>
                                        ...
                                        <p>Gain in-demand skills in data analytics and unlock career opportunities across industries.</p>
                                ...
                                <div class="swiper-slide gridarea__wraper gridarea__wraper__2">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_10.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge">SAP</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                            <a href="#"><i class="icofont-heart-alt"></i></a>
                                        </div>
                                    ...
                                    <div class="gridarea__content">
                                        <div class="gridarea__list">
                                            <ul>
                                                <li>
                                                    <i class="icofont-book-alt"></i> 35 Lesson
                                                </li>
                                                <li>
                                                    <i class="icofont-clock-time"></i> 5 to 6 months
                                                </li>
                                        ...
                                        <div class="gridarea__heading">
                                            <h3><a href="course-details.php">SAP <span>(FICO,MM,PP,ABAP)</span></a></h3>
                                        </div>
                                        <p>Master financial accounting and controlling processes with real-time SAP FICO training.</p>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2 about__right__wraper__4">
                            <div class="educationarea__img" data-tilt>
                                <img loading="lazy"  class="aboutimg__4__img__1" src="img/about/about_13.png" alt="about">
                                <img loading="lazy"  class="aboutimg__4__img__2" src="img/about/about_12.png" alt="about">
                            </div>
                ...
                <div class="row populerarea__wraper">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="populerarea__heading heading__underline">
                            <div class="default__small__button">Most Popular Courses</div>
                            <h2>Populer <span>Courses</span></h2>
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-5 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="populerarea__content">
                            <p>Upgrade your skills with our industry-focused training programs designed for real-world success.</p>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.php">Full Stack Web Development</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.php">Mobile App Development</a></h3>
                                <p>Android, iOS, React Native, Flutter</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z" stroke="#FFB31F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.php">Artist & Design</a></h3>
                                <p>show creativity</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.php">Machine Learning</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.php">Marketing Analysis</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6" data-aos="fade-up">
                        <div class="single__service">
                            ...
                            <div class="service__content">
                                <h3><a href="course-details.php">Business Studies</a></h3>
                                <p>Learn the art of building success</p>
                            </div>
                            <div class="service__small__img">
                                <svg class="icon__hover__img" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16.5961 10.265L19 1.33069L10.0022 3.73285L1 6.1306L7.59393 12.6627L14.1879 19.1992L16.5961 10.265Z" stroke="#FFB31F" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <div class="row grid__row">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="section__title__2">
                            ...
                            <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                                <h2>Perfect Training Programs for Your Career</h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12" data-aos="fade-up">
                        <div class="gridfilter_nav grid__filter__2 gridFilter">
                            ...
                            <button data-filter=".filter3" class="">Devlopment </button>
                            <button data-filter=".filter4" class="">Design</button>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter2 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                ...
                                <div class="gridarea__small__button">
                                    <div class="grid__badge blue__color">Google</div>
                                </div>
                                <div class="gridarea__small__icon">
                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                ...
                                <div class="gridarea__small__button">
                                    <div class="grid__badge orange__color">Data & Analytics</div>
                                </div>
                                <div class="gridarea__small__icon">
                                    <a href="#"><i class="icofont-heart-alt"></i></a>
                                </div>
                    ...
                    <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="registerarea__wraper">
                            <div class="section__title registerarea__section__title">
                                <div class="section__title__button">
                                    <div class="default__small__button">Resister Now</div>
                                </div>
