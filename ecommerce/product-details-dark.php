...
<head>
    ...
    <title>Product-Details Dark | Edurock - Education LMS Template</title>
                                ...
                                <nav>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        ...
                                                        <ul class="mega__menu__item">
                                                            ...
                                                            <li><a href="/ourse-details-3.php">Course Details 3</a></li>
                                                            <li><a href="/ourse-details-3.php">Details 3 (Dark)</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Get Started 3</a></h4>
                                    ...
                                    <li><a class="headerarea__has__dropdown" href="/dashboard/instructor-dashboard.php">Dashboard
                                        ...
                                        <ul class="headerarea__submenu headerarea__submenu--third--wrap">
                                            <li><a href="/dashboard/admin-dashboard.php">Admin <i class="icofont-rounded-right"></i></a>
...
<li><a href="/dashboard/student-message.php">Message</a></li>
                                    ...
                                    <ul class="headerarea__submenu">
                                        <li><a href="shop.php">Shop<span class="mega__menu__label">Online Store</span></a></li>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper product__grid">
                                ...
                                <div class="gridarea__content">
                                    ...
                                    <div class="gridarea__heading">
                                        <h3><a href="product-details.php">Nice stand about peek</a></h3>
                                    </div>
                                    <div class="gridarea__price">
                                        $56.00 <del>/ $99.00</del>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper product__grid">
                                ...
                                <div class="gridarea__content">
                                    ...
                                    <div class="gridarea__heading">
                                        <h3><a href="product-details.php">Nided minid lnided codad</a></h3>
                                    </div>
                                    <div class="gridarea__price">
                                        $57.00 <del>/ $88.00</del>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper product__grid">
                                ...
                                <div class="gridarea__content">
                                    ...
                                    <div class="gridarea__heading">
                                        <h3><a href="product-details.php">Pendi mandie kond maedsd</a></h3>
                                    </div>
                                    <div class="gridarea__price">
                                        $88.00 <del>/ $99.00</del>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                            <div class="gridarea__wraper product__grid">
                                ...
                                <div class="gridarea__content">
                                    ...
                                    <div class="gridarea__heading">
                                        <h3><a href="product-details.php">Book stand about softwere</a></h3>
                                    </div>
                                    <div class="gridarea__price">
                                        $32.00 <del>/ $67.00</del>
                                    </div>
                        ...
                        <div class="social__wrapper">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                                    <div class="gridarea__wraper gridarea__wraper__2">
                                        <div class="gridarea__img">
                                            <a href="/course-details.php"><img loading="lazy"  src="../img/grid/kid_1.jpg" alt="grid"></a>
                                            <div class="gridarea__small__button">
                                                <div class="grid__badge">Data & Tech</div>
                                            </div>
                                            <div class="gridarea__small__icon">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                                    <div class="gridarea__wraper gridarea__wraper__2">
                                        <div class="gridarea__img">
                                            <img loading="lazy"  src="../img/grid/kid_2.jpg" alt="grid">
                                            <div class="gridarea__small__button">
                                                <div class="grid__badge blue__color">Mechanical</div>
                                            </div>
                                            <div class="gridarea__small__icon">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                                    <div class="gridarea__wraper gridarea__wraper__2">
                                        <div class="gridarea__img">
                                            <a href="/course-details.php"><img loading="lazy"  src="../img/grid/kid_3.jpg" alt="grid"></a>
                                            <div class="gridarea__small__button">
                                                <div class="grid__badge pink__color">Development</div>
                                            </div>
                                            <div class="gridarea__small__icon">
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                                    <div class="gridarea__wraper gridarea__wraper__2">
                                        <div class="gridarea__img">
                                            <a href="/course-details.php"><img loading="lazy"  src="../img/grid/kid_4.jpg" alt="grid"></a>
                                            <div class="gridarea__small__button">
                                                <div class="grid__badge green__color">Ui & UX Design</div>
                                            </div>
                                            <div class="gridarea__small__icon">
