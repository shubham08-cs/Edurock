...
<head>
    ...
    <title>Cart-Dark | Edurock - Education LMS Template</title>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="cartarea__product__thumbnail">
                                                <a href="#">
                                                    <img loading="lazy"  src="../img/products/2.jpg" alt="product-1">
                                                </a>
                                            </td>
                                            <td class="cartarea__product__name"><a href="product-details.php">Product title acc 10 - s / red</a></td>
                                        ...
                                        <tr>
                                            <td class="cartarea__product__thumbnail">
                                                <a href="#">
                                                    <img loading="lazy"  src="../img/products/1.jpg" alt="product 2">
                                                </a>
                                            </td>
                                            <td class="cartarea__product__name"><a href="product-details.php">Product title acc 10 - s / red</a></td>
                                            <td class="cartarea__product__price__cart"><span class="amount">$110.00</span></td>
