                                ...
                                <ul>
                                            ...
                                            <ul class="nav  tab__button__wrap" id="myTab2" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="single__tab__link active" data-bs-toggle="tab"
                                                            data-bs-target="#projects__light" type="button">Light
                                                    </button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="single__tab__link" data-bs-toggle="tab"
                                                            data-bs-target="#projects__dark" type="button">Dark
                                                    </button>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-3 mega__menu__single__wrap">
                                                    ...
                                                    <ul class="mega__menu__item">
                                                        <li><a href="about.php">About <span class="mega__menu__label">Sale Everything</span></a>
                                                        </li>
                                                ...
                                                <div class="col-3 mega__menu__single__wrap">
                                                    ...
                                                    <ul class="mega__menu__item">
                                                        <li><a href="zoom/zoom-meeting-details-dark.php">Meeting Details
                                                                (Dark)</a></li>
                                        ...
                                        <div class="headerarea__submenu mega__menu__wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-3 mega__menu__single__wrap">
                                                    <h4 class="mega__menu__title"><a href="#">Get Started 1 </a></h4>
                                                    <ul class="mega__menu__item">
                                                        <li><a href="course.php">Grid <span class="mega__menu__label">All Courses</span></a>
                                                        </li>
                                                ...
                                                <div class="col-3 mega__menu__single__wrap">
                                                    ...
                                                    <ul class="mega__menu__item">
                                                        ...
                                                        <li><a href="course-details-dark.php">Course Details (Dark)</a>
                                                        </li>
                                                        <li><a href="course-details-2.php">Course Details 2</a></li>
                                                        <li><a href="course-details-2-dark.php">Details 2 (Dark)</a>
                                                        </li>
                                    ...
                                    <li><a class="headerarea__has__dropdown" href="dashboard/instructor-dashboard.php">Dashboard
                                        ...
                                        <ul class="headerarea__submenu headerarea__submenu--third--wrap">
                                            <li><a href="/admin-dashboard.php">Admin <i
                                            ...
                                            <li>
                                                ...
                                                <ul class="headerarea__submenu--third">
                                                    ...
                                                    <li>
                                                        <a href="dashboard/instructor-announcments.php">Announcements</a>
                                                    </li>
                                    ...
                                    <li><a class="headerarea__has__dropdown" href="ecommerce/shop.php">eCommerce
                                        ...
                                        <ul class="headerarea__submenu">
                                            <li><a href="ecommerce/shop.php">Shop<span class="mega__menu__label">Online Store</span></a>
                                            </li>
                    ...
                    <nav>
                        <ul class="mobile-menu">
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="error-dark.php">Error (Dark)</a></li>
                                            <li><a href="event-details.php">Event Details</a></li>
                                            <li><a href="zoom/zoom-meetings.php">Zoom<span class="mega__menu__label">Online Call</span></a>
                                            </li>
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="instructor-dark.php">Instructor (Dark)</a></li>
                                            <li><a href="instructor-details.php">Instructor Details</a></li>
                                            <li><a href="lesson.php">Course Lesson<span class="mega__menu__label new">New</span></a>
                                            </li>
                                        </ul>
                                    </li>
                                ...
                                <ul class="dropdown">
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="dashboard/student-profile.php">Profile</a></li>
                                            <li><a href="dashboard/student-message.php">Message</a></li>
                                            <li><a href="dashboard/student-enrolled-courses.php">Enrolled Courses</a>
                                            </li>
                                            <li><a href="dashboard/student-wishlist.php">Wishlist</a></li>
                                            <li><a href="dashboard/student-reviews.php">Review</a></li>
                            ...
                            <li class="menu-item-has-children"><a href="ecommerce/shop.php">eCommerce</a>
                                <ul class="dropdown">
                                    <li><a href="ecommerce/shop.php">Shop<span
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    ...
                    <div class="aboutarea__content__wraper">
                        ...
                        <div class="aboutarea__para aboutarea__para__2">
                            <p>25+Contrary to popular belief, Lorem Ipsum is not simply random text roots in a piece of
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 about__wrap__content" data-aos="fade-up">
                    ...
                    <div class="populerarea__content__wraper__2">
                        ...
                        <div class="populerarea__content__2">
                            <p class="populerarea__para__1">Construction is a general term meaning the art and science
                                to form systems organizations, and comes from Latin Construction is</p>
                            <p class="populerarea__para__2">Construction is a general term meaning the art and science
                                to form systems organizations, and comes from Latin Construction is a organizations, and
                                comes from Latin construction and Old</p>
                        </div>
                    ...
                    <div class="registerarea__wraper">
                        <div class="section__title registerarea__section__title">
                            ...
                            <div class="section__title__heading heading__underline">
                                <h2>Register Your <span>Account </span>Get free access to <small>60000</small> online
                                    course
                                </h2>
                            </div>
                        </div>
                    ...
                    <div class="pricingarea__content__wraper">
                        <div class="pricingarea__heading">
                            ...
                            <div class="pricingarea__number">
                                <h1><span class="price__currency">$</span>0<span class="price__durition">/ month</span>
                                </h1>
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="pricingarea__content__wraper">
                        <div class="pricingarea__heading">
                            ...
                            <div class="pricingarea__number">
                                <h1><span class="price__currency">$</span>29<span class="price__durition">/ month</span>
                                </h1>
                            </div>
                            <p>Perfect for startup</p>
                        </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="pricingarea__content__wraper">
                        <div class="pricingarea__heading">
                            ...
                            <div class="pricingarea__number">
                                <h1><span class="price__currency">$</span>59<span class="price__durition">/ month</span>
                                </h1>
                            </div>
                            <p>Perfect for startup</p>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                    ...
                    <div class="aboutarea__3__content">
                        <p>Construction is a general term meaning the art and science to form systems organizations and
                            comes from Latin Construction is</p>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                    <div class="aboutarea__content__wraper__3">
                        <div class="aboutarea__para__3">
                            <p>“The other hand we denounce righteou indg ation men who are so beguiled and demoraliz by
                                the the mo ment.Dislike men who so development co” </p>
                        ...
                        <div class="blogarea__text__wraper">
                            ...
                            <div class="blogarea__para">
                                <p>A wonderful serenity has taken possssion of my entire souing like these sweet morning
                                    spring whch enjoy with my whole heart I am alone, and feel the charm of existenceths
                                    spot whch was create For the bliss of souls
                                    like mineing am so happy my dear frend so absori bed in the exquste sens of mere. A
                                    wonderful serenity has taken posseson of my entire soung like these sweet mornngs
                                    spring whch enjoy …</p>
                            </div>
