...
<head>
    ...
    <title>Instructor  Settings | Edurock - Education LMS Template</title>
                                                ...
                                                <li>
                                                    ...
                                                    <ul class="headerarea__submenu--third">
                                                        ...
                                                        <li><a href="/dashboard/instructor-profile.php">Inst.
                                                                Profile</a></li>
                                                        <li><a href="/dashboard/instructor-message.php">Message</a>
                                                        </li>
                        ...
                        <div class="col-xl-3 col-lg-3 col-md-12">
                            <div class="dashboard__inner">
                                ...
                                <div class="dashboard__nav">
                                    <ul>
                                        <li>
                                            <a class="active" href="instructor-settings.php">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
