...
<head>
    ...
    <title>Student Message | Edurock - Education LMS Template</title>
                                ...
                                <div class="dashboardarea__inner student__dashboard__inner">
                                    ...
                                    <div class="dashboardarea__right">
                                        <div class="dashboardarea__right__button">
                                            <a class="default__button" href="create-course.php">Enroll A New Course
                            ...
                            <div class="dashboard__inner sticky-top">
                                ...
                                <div class="dashboard__nav">
                                    <ul>
                                        ...
                                        <li>
                                            <a class="active" href="student-message.php">
                                        ...
                                        <li>
                                            <a href="student-my-quiz-attempts.php">
