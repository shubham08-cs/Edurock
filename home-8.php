...
<head>
    ...
    <title>Home-8 e-Commerce | Edurock - Education LMS Template</title>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="headerarea__left">
                                <div class="headerarea__left__logo">
                                    ...
                                    <a href="index.php"><img loading="lazy"  src="img/logo/logo_1.png" alt="logo"></a>
                                </div>
                                ...
                                <nav>
                                    <ul>
                                        ...
                                        <li class="mega__menu position-static">
                                            <a class="headerarea__has__dropdown" href="index.php">Demos<i class="icofont-rounded-down"></i> </a>
                                        ...
                                        <li class="mega__menu position-static">
                                            <a class="headerarea__has__dropdown" href="about.php">Pages<i class="icofont-rounded-down"></i> </a>
                                                ...
                                                <div class="row">
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        ...
                                                        <ul class="mega__menu__item">
                                                            <li><a href="about.php">About <span class="mega__menu__label">Sale Everything</span></a></li>
                                                            <li><a href="about-dark.php">About (Dark)<span class="mega__menu__label new">New</span></a></li>
                                                            <li><a href="blog.php">Blog</a></li>
                                                            <li><a href="blog-dark.php">Blog (Dark)</a></li>
                                                            <li><a href="blog-details.php">Blog Details</a></li>
                                                            <li><a href="blog-details-dark.php">Blog Details (Dark)</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        ...
                                                        <ul class="mega__menu__item">
                                                            ...
                                                            <li><a href="error-dark.php">Error (Dark)</a></li>
                                                            <li><a href="event-details.php">Event Details</a></li>
                                                            <li><a href="zoom/zoom-meetings.php">Zoom<span class="mega__menu__label">Online Call</span></a></li>
                                                            <li><a href="zoom/zoom-meetings-dark.php">Zoom Meeting (Dark)</a></li>
                                                            <li><a href="zoom/zoom-meeting-details.php">Zoom Meeting Details</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Get Started 3</a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="zoom/zoom-meeting-details-dark.php">Meeting Details (Dark)</a></li>
                                                            <li><a href="login.php">Login</a></li>
                                                            <li><a href="login-dark.php">Login (Dark)</a></li>
                                                            <li><a href="maintenance.php">Maintenance</a></li>
                                                            <li><a href="maintenance-dark.php">Maintenance Dark</a></li>
                                                    ...
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        ...
                                                        <ul class="mega__menu__item">                                                            
                                                            ...
                                                            <li><a href="contact-dark.php">Contact (Dark)</a></li>
                                        ...
                                        <li class="mega__menu position-static">
                                            <a class="headerarea__has__dropdown" href="course.php">Courses<i class="icofont-rounded-down"></i> </a>
                                            <div class="headerarea__submenu mega__menu__wrapper">
                                                ...
                                                <div class="row">
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Get Started 1 </a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="course.php">Grid <span class="mega__menu__label">All Courses</span></a></li>
                                                            <li><a href="course-dark.php">Course Grid (Dark)</a></li>
                                                            <li><a href="course-grid.php">Course Grid</a></li>
                                                            <li><a href="course-grid-dark.php">Course Grid (Dark)</a></li>
                                                            <li><a href="course-list.php">Course List</a></li>
                                                            <li><a href="course-list-dark.php">Course List (Dark)</a></li>
                                                    ...
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        ...
                                                        <ul class="mega__menu__item">
                                                            ...
                                                            <li><a href="course-details-dark.php">Course Details (Dark)</a></li>
                                                            <li><a href="course-details-2.php">Course Details 2</a></li>
                                                            <li><a href="course-details-2-dark.php">Details 2 (Dark)</a></li>
                                                            <li><a href="course-details-3.php">Course Details 3</a></li>
                                                            <li><a href="course-details-3.php">Details 3 (Dark)</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        <h4 class="mega__menu__title"><a href="#">Get Started 3</a></h4>
                                                        <ul class="mega__menu__item">
                                                            <li><a href="dashboard/become-an-instructor.php">Become An Instructor</a>
                                                            <li><a href="dashboard/create-course.php">Create Course <span class="mega__menu__label">Career</span></a></li>
                                                            <li><a href="instructor.php">Instructor</a></li>
                                                            <li><a href="instructor-dark.php">Instructor (Dark)</a></li>
                                                            <li><a href="instructor-details.php">Instructor Details</a></li>
                                                            <li><a href="lesson.php">Course Lesson<span class="mega__menu__label new">New</span></a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-3 mega__menu__single__wrap">
                                                        <div class="mega__menu__img">
                                    ...
                                    <li><a class="headerarea__has__dropdown" href="dashboard/instructor-dashboard.php">Dashboard
                                            <i class="icofont-rounded-down"></i>
                                        </a>
                                        <ul class="headerarea__submenu headerarea__submenu--third--wrap">
                                            <li><a href="/admin-dashboard.php">Admin <i class="icofont-rounded-right"></i></a>
                                    
                                                <ul class="headerarea__submenu--third">
                                                    <li><a href="dashboard/admin-dashboard.php">Admin Dashboard</a></li>
                                                    <li><a href="dashboard/admin-profile.php">Admin Profile</a></li>
                                                    <li><a href="dashboard/admin-message.php">Message</a></li>
                                                    <li><a href="dashboard/admin-course.php">Courses</a></li>
                                                    <li><a href="dashboard/admin-reviews.php">Review</a></li>
                                                    <li><a href="dashboard/admin-quiz-attempts.php">Admin Quiz</a></li>
                                                    
                                                    <li><a href="dashboard/admin-settings.php">Settings</a></li>
                                                </ul>
                                    
                                            </li>
                                            <li>
                                                <a href="dashboard/instructor-dashboard.php">Instructor <i class="icofont-rounded-right"></i></a>
                                                <ul class="headerarea__submenu--third">
                                                    <li><a href="dashboard/instructor-dashboard.php">Inst. Dashboard</a></li>
                                                    <li><a href="dashboard/instructor-profile.php">Inst. Profile</a></li>
                                                    <li><a href="dashboard/instructor-message.php">Message</a></li>
                                                    <li><a href="dashboard/instructor-wishlist.php">Wishlist</a></li>
                                                    <li><a href="dashboard/instructor-reviews.php">Review</a></li>
                                                    <li><a href="dashboard/instructor-my-quiz-attempts.php">My Quiz</a></li>
                                                    <li><a href="dashboard/instructor-order-history.php">Order History</a></li>
                                                    <li><a href="dashboard/instructor-course.php">My Courses</a></li>
                                                    <li><a href="dashboard/instructor-announcments.php">Announcements</a></li>
                                                    <li><a href="dashboard/instructor-quiz-attempts.php">Quiz Attempts</a></li>
                                                    <li><a href="dashboard/instructor-assignments.php">Assignment</a></li>
                                                    <li><a href="dashboard/instructor-settings.php">Settings</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="dashboard/student-dashboard.php">Student <i class="icofont-rounded-right"></i></a>
                                                <ul class="headerarea__submenu--third">
                                                    <li><a href="dashboard/student-dashboard.php">Dashboard</a></li>
                                                    <li><a href="dashboard/student-profile.php">Profile</a></li>
<li><a href="dashboard/student-message.php">Message</a></li>
                                                    <li><a href="dashboard/student-enrolled-courses.php">Enrolled Courses</a></li>
                                                    <li><a href="dashboard/student-wishlist.php">Wishlist</a></li>
                                                    <li><a href="dashboard/student-reviews.php">Review</a></li>
                                                    <li><a href="dashboard/student-my-quiz-attempts.php">My Quiz</a></li>
                                                    <li><a href="dashboard/student-assignments.php">Assignment</a></li>
                                                    <li><a href="dashboard/student-settings.php">Settings</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>

                                    <li><a class="headerarea__has__dropdown" href="ecommerce/shop.php">eCommerce
                                        <i class="icofont-rounded-down"></i>
                                    </a>
                                    <ul class="headerarea__submenu">
                                        <li><a href="ecommerce/shop.php">Shop<span class="mega__menu__label">Online Store</span></a></li>
                                        ...
                                        <li><a href="ecommerce/wishlist.php">Wishlist</a></li>
                                    </ul>
                                </li>
                                ...
                                <div class="header__cart">
                                    ...
                                    <div class="header__right__dropdown__wrapper">
                                        <div class="header__right__dropdown__inner">
                                            <div class="single__header__right__dropdown">
                                                ...
                                                <div class="header__right__dropdown__content">
                                                    ...
                                                    <a href="shop-product.php">Web Directory</a>
                                            ...
                                            <div class="single__header__right__dropdown">
                                                ...
                                                <div class="header__right__dropdown__content">
                                                    ...
                                                    <a href="shop-product.php">Design Minois</a>
                                            ...
                                            <div class="single__header__right__dropdown">
                                                ...
                                                <div class="header__right__dropdown__content">
                                                    ...
                                                    <a href="shop-product.php">Crash Course</a>
                                        ...
                                        <div class="header__right__dropdown__button">
                                            <a href="ecommerce/cart.php" class="white__color">View Cart</a>
                                            <a href="ecommerce/checkout.php" class="blue__color">Checkout</a>
                                        </div>
                                    </div>
                                </div>

                                <div class="headerarea__login">
                                    <a href="login.php"><i class="icofont-user-alt-5"></i></a>
                                </div>
                        ...
                        <nav>
                            <ul class="mobile-menu">
                                <li class="menu-item-has-children"><a href="index.php">Home</a>
                                    <ul class="dropdown">
                                        <li class="menu-item-has-children"><a href="index.php">Homes Light</a>
                                            <ul class="dropdown">
                                                <li><a href="index.php">Home (Default)</a></li>
                                                <li><a href="home-2.php">Elegant</a></li>
                                                <li><a href="home-3.php">Classic</a></li>
                                                <li><a href="home-4.php">Classic LMS</a></li>
                                                <li><a href="home-5.php">Online Course </a></li>
                                                <li><a href="home-6.php">Marketplace </a></li>
                                                <li><a href="home-7.php">University</a></li>
                                                <li><a href="home-8.php">eCommerce</a></li>
                                                <li><a href="home-9.php">Kindergarten</a></li>
                                                <li><a href="home-10.php">Machine Learning</a></li>
                                                <li><a href="home-11.php">Single Course</a></li>
                                            </ul>
                                        </li>
        
                                        <li class="menu-item-has-children">
                                            <a href="index.php">Homes Dark</a>
                                            <ul class="dropdown">
                                                <li><a href="index-dark.php">Home Default (Dark)</a></li>
                                                <li><a href="home-2-dark.php">Elegant (Dark)</a></li>
                                                <li><a href="home-3-dark.php">Classic (Dark)</a></li>
                                                <li><a href="home-4-dark.php">Classic LMS (Dark)</a></li>
                                                <li><a href="home-5-dark.php">Online Course (Dark)</a></li>
                                                <li><a href="home-6-dark.php">Marketplace (Dark)</a></li>
                                                <li><a href="home-7-dark.php">University (Dark)</a></li>
                                                <li><a href="home-8-dark.php">eCommerce (Dark)</a></li>
                                                <li><a href="home-9-dark.php">Kindergarten (Dark)</a></li>
                                                <li><a href="home-10-dark.php">Kindergarten (Dark)</a></li>
                                                <li><a href="home-11-dark.php">Single Course (Dark)</a></li>
                                            </ul>
                                        </li>
                                ...
                                <li class="menu-item-has-children "><a href="#">Pages</a>
                                    ...
                                    <ul class="dropdown">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="dropdown">
                                                <li><a href="zoom/zoom-meeting-details-dark.php">Meeting Details (Dark)</a>
                                                </li>
                                                <li><a href="login.php">Login</a></li>
                                                <li><a href="login-dark.php">Login (Dark)</a></li>
                                                <li><a href="maintenance.php">Maintenance</a></li>
                                ...
                                <li class="menu-item-has-children "><a href="dashboard/admin-dashboard.php">Dashboard</a>
...
<li><a href="dashboard/student-message.php">Message</a></li>
                                ...
                                <li class="menu-item-has-children"><a href="ecommerce/shop.php">eCommerce</a>
                                    <ul class="dropdown">
                                        <li><a href="ecommerce/shop.php">Shop<span class="mega__menu__label">Online Store</span></a></li>
                                        <li><a href="ecommerce/product-details.php">Product Details</a></li>
                                        <li><a href="ecommerce/cart.php">Cart</a></li>
        ...
        <div class="herobannerarea herobannerarea__2 herobannerarea__ecomarece">
                ...
                <div class="herobannerarea__slider__wrap swiper-wrapper">
                        ...
                        <div class="row">
                                ...
                                <div class="herobannerarea__content__wraper">
                                    ...
                                    <div class="herobannerarea__title">
                                        ...
                                        <div class="herobannerarea__title__heading__2 herobannerarea__title__heading__3">
                                            <h2>School Bag <span>Ninbn</span></h2>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__img">
                                    <img loading="lazy"  src="img/herobanner/herobanner__slider.png" alt="">
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="swiper-slide herobannerarea__single__slider">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__img">
                                    <img loading="lazy"  src="img/herobanner/herobanner__slider__2.png" alt="">
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="swiper-slide herobannerarea__single__slider">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__img">
                                    <img loading="lazy"  src="img/herobanner/herobanner__slider__3.png" alt="">
                                </div>
                            </div>
                        </div>
                        </div>
        ...
        <div class="gridarea__2 sp_bottom_70 sp_top_30" data-aos="fade-up">
                    ...
                    <div class="swiper featured__course">
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/1.jpg" alt="grid"></a>
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <div class="gridarea__heading">
                                            <h3><a href="ecommerce/product-details.php">Book stand about Software</a></h3>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/2.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <div class="gridarea__heading">
                                            <h3><a href="ecommerce/product-details.php">Nice stand about peek</a></h3>
                                        </div>
                                        <div class="gridarea__price">
                                            $56.00 <del>/ $99.00</del>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/3.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <div class="gridarea__heading">
                                            <h3><a href="ecommerce/product-details.php">Nided minid lnided codad</a></h3>
                                        </div>
                                        <div class="gridarea__price">
                                            $57.00 <del>/ $88.00</del>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/4.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <div class="gridarea__heading">
                                            <h3><a href="ecommerce/product-details.php">Pendi mandie kond maedsd</a></h3>
                                        </div>
                                        <div class="gridarea__price">
                                            $88.00 <del>/ $99.00</del>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/5.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                            <div class="grid__badge">Sale</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                                    ...
                                    <div class="gridarea__content">
                                        ...
                                        <div class="gridarea__heading">
                                            <h3><a href="ecommerce/product-details.php">Book stand about softwere</a></h3>
                                        </div>
                                        <div class="gridarea__price">
                                            $32.00 <del>/ $67.00</del>
                                        </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/6.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                            <div class="grid__badge blue__color">New</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/7.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                            <div class="grid__badge green__color">Sold Out</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper product__grid">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/products/8.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                                            <div class="grid__badge yellow__color">20% Off</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                        ...
                        <div class="aboutarea__content__wraper">
                            ...
                            <div class="section__title__2">
                                ...
                                <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                                    <h2>Welcome to our awesome online Store.</h2>
                                </div>
                            </div>
                            ...
                            <div class="aboutarea__list__2">
                                <ul>
                                    ...
                                    <li>
                                        <i class="icofont-check"></i>Next ipsum dolor sit amet consectetur elit.
                                    </li>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2 about__right__wraper__4">
                            <div class="educationarea__img" data-tilt>
                                <img loading="lazy"  class="aboutimg__4__img__1" src="img/about/about_online_store.png" alt="about">
                            </div>
        ...
        <div class="trainingarea sp_bottom_50" data-aos="fade-up">
            <div class="container-fluid full__width__padding">
                <div class="row">
        ...
        <div class="gridarea">
            <div class="container-fluid full__width__padding">
                ...
                <div class="row grid" data-aos="fade-up">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter2 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4 filter5">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_3.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.php">Minws course to under stand
                                        about solution</a></h3>
                                </div>
                                <div class="gridarea__price">
                                    $40.00 <del>/ $67.00</del>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_4.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.php">Design course to under stand
                                        about solution</a></h3>
                                </div>
                                <div class="gridarea__price">
                                    $40.00 <del>/ $67.00</del>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_5.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.php">Data course to under stand
                                        about solution</a></h3>
                                </div>
                                <div class="gridarea__price">
                                    $40.00 <del>/ $67.00</del>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter5 filter2">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_6.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__heading">
                                    <h3><a href="course-details.php">Big data to under stand
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4 filter5">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_7.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                                    <div class="grid__badge pink__color">Development</div>
                                </div>
                                <div class="gridarea__small__icon">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="img/grid/grid_8.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                                    <div class="grid__badge green__color">Ui & UX Design</div>
                                </div>
                                <div class="gridarea__small__icon">
                        ...
                        <div class="blogarea__content__wraper">
                            ...
                            <div class="blogarea__text__wraper">
                                ...
                                <div class="blogarea__para">
                                    <p>A wonderful serenity has taken possssion of my entire souing like these sweet morning spring whch enjoy with my whole heart I am alone, and feel the charm of existenceths spot whch was create For the bliss of souls like mineing am so happy my dear frend so absori bed in the exquste sens of mere.</p>
                                </div>
                                ...
                                <div class="featurearea__details__img">
                                    ...
                                    <div class="featurearea__big__img--modal swiper-wrapper">
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/1.jpg" alt="Product Big Img">
                                        </div>
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/2.jpg"  alt="Product Big Img">
                                        </div>
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/3.jpg"  alt="Product Big Img">
                                        </div>
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/4.jpg"  alt="Product Big Img">
                                        </div>
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/5.jpg"  alt="Product Big Img">
                                        </div>
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/6.jpg"  alt="Product Big Img">
                                        </div>
                                        <div class="featurearea__single__big__img swiper-slide">
                                            <img loading="lazy"  src="img/products/7.jpg"  alt="Product Big Img">
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div thumbsSlider="" class="swiper modal__gallery">
                                        <div class=" featurearea__thumb__img--modal swiper-wrapper">
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/1.jpg" alt="Product Thumb Img">
                                            </div>
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/2.jpg" alt="Product Thumb Img">
                                            </div>
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/3.jpg" alt="Product Thumb Img">
                                            </div>
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/4.jpg" alt="Product Thumb Img">
                                            </div>
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/5.jpg" alt="Product Thumb Img">
                                            </div>
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/6.jpg" alt="Product Thumb Img">
                                            </div>
                                            <div class="featurearea__single__thumb__img swiper-slide">
                                                <img loading="lazy"  src="img/products/7.jpg" alt="Product Thumb Img">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                    <div class="featurearea__inner">
                                        ...
                                        <div class="featurearea__main__title">
                                            <h3><a href="product-details.php">Book stand about Software</a></h3>
                                        </div>
                                        ...
                                        <ul>
                                            <li><a href="#"><img loading="lazy"  src="img/products/1.jpg" alt=""></a></li>
                                            <li><a href="#"><img loading="lazy"  src="img/products/2.jpg" alt=""></a></li>
                                            <li><a href="#"><img loading="lazy"  src="img/products/3.jpg" alt=""></a></li>
                                            <li><a href="#"><img loading="lazy"  src="img/products/4.jpg" alt=""></a></li>
                                            <li><a href="#"><img loading="lazy"  src="img/products/5.jpg" alt=""></a></li>
                                        </ul>
                                        </div>
                                        <div class="featurearea__size">
                                            <span>Quantity</span>
