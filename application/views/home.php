                    ...
                    <div class="row headerarea__search__wrap align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            ...
                            <div class="headerarea__2__info__img">
                                <a href="#"><img loading="lazy"  src="assets/img/icon/flag1.webp" alt="img">
                                    ENG
                                ...
                                <ul class="language__dropdown">
                                    <li><a href="#"><img loading="lazy"  src="assets/img/icon/flag2.webp" class="img-fluid" alt="">
                                            FR</a></li>
                                    <li><a href="#"><img loading="lazy"  src="assets/img/icon/flag3.webp" class="img-fluid" alt="">
                                            DE</a></li>
                                </ul>
                            </div>
                            ...
                            <div class="headerarea__2__info__img">
                                ...
                                <ul class="language__dropdown">
                                    <li><a href="#"><img loading="lazy"  src="assets/img/logo/logo__4.webp" class="img-fluid" alt="">
                                            FR</a></li>
                                    <li><a href="#"><img loading="lazy"  src="assets/img/logo/logo__5.webp" class="img-fluid" alt="">
                                            DE</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-6">
                            <div class="headerarea__left">
                                <div class="headerarea__left__logo">
                                    ...
                                    <a href="index.php"><img loading="lazy"  src="assets/img/logo/logo_1.png" alt="logo"></a>
                                </div>
...
<li><a href="dashboard/student-message.php">Message</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="herobanner__video registerarea__video">
                            <img loading="lazy"  src="assets/img/herobanner/herobanner__video.jpg" alt="Video Banner">

                            <div class="video__pop__btn">
                                <a class="video-btn" href="https://www.youtube.com/watch?v=vHdclsdkp28"> <img loading="lazy"  src="assets/img/icon/video.png" alt=""></a>
                            </div>
                        </div>
                    ...
                    <div class="herobannerarea__icon__2">
                        <img loading="lazy"  class="herobanner__common__img herobanner__img__1" src="assets/img/herobanner/herobanner__1.png" alt="photo">
                        <img loading="lazy"  class="herobanner__common__img herobanner__img__2" src="assets/img/herobanner/herobanner__2.png" alt="photo">
                        <img loading="lazy"  class="herobanner__common__img herobanner__img__3" src="assets/img/herobanner/herobanner__3.png" alt="photo">
                        <img loading="lazy"  class="herobanner__common__img herobanner__img__4" src="assets/img/herobanner/herobanner__4.png" alt="photo">
                        <img loading="lazy"  class="herobanner__common__img herobanner__img__5" src="assets/img/herobanner/herobanner__5.png" alt="photo">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid full__width__padding">
                <div class="animate__content__wrap">
                    ...
                    <div class="single__service">
                        ...
                        <div class="service__content">
                            <h3><a href="course-details.php">Programming Tech</a></h3>
                    ...
                    <div class="swiper featured__course">
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_7.png" alt="grid"></a>
                                        ...
                                        <div class="gridarea__bottom">
                                            ...
                                            <a href="instructor-details.php">
                                                <div class="gridarea__small__img">
                                                    <img loading="lazy"  src="assets/img/grid/grid_small_1.jpg" alt="grid">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_8.png" alt="grid"></a>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_9.png" alt="grid"></a>
                                        <div class="gridarea__small__button">
                                            <div class="grid__badge">Data & Tech</div>
                                        </div>
                                        <div class="gridarea__small__icon">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2 about__right__wraper__4">
                            <div class="educationarea__img" data-tilt>
                                <img loading="lazy"  class="aboutimg__4__img__1" src="assets/img/about/about_13.png" alt="about">
                                <img loading="lazy"  class="aboutimg__4__img__2" src="assets/img/about/about_12.png" alt="about">
                            </div>
            ...
            <div class="container">
                ...
                <div class="row grid" data-aos="fade-up">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_1.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                                    <div class="grid__badge">Data & Tech</div>
                                </div>
                                <div class="gridarea__small__icon">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4 filter5">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_3.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <a href="instructor-details.php">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy"  src="assets/img/grid/grid_small_3.jpg" alt="grid">
                                            <div class="gridarea__small__content">
                                                <h6>Micle Jhon</h6>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter4">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_4.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <a href="instructor-details.php">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy"  src="assets/img/grid/grid_small_4.jpg" alt="grid">
                                            <div class="gridarea__small__content">
                                                <h6>Micle Robin</h6>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter1 filter3">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_5.png" alt="grid"></a>
                                <div class="gridarea__small__button">
                            ...
                            <div class="gridarea__content">
                                ...
                                <div class="gridarea__bottom">
                                    ...
                                    <a href="instructor-details.php">
                                        <div class="gridarea__small__img">
                                            <img loading="lazy"  src="assets/img/grid/grid_small_5.jpg" alt="grid">
                                            <div class="gridarea__small__content">
                                                <h6>Micle Robin</h6>
                                            </div>
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item filter5 filter2">
                        <div class="gridarea__wraper">
                            <div class="gridarea__img">
                                <a href="course-details.php"><img loading="lazy"  src="assets/img/grid/grid_6.png" alt="grid"></a>
                                <div class="gridarea__small__button">
        ...
        <div class="registerarea sp_top_90">
            ...
            <div class="registerarea__img">
                <img loading="lazy"  class="register__1" src="assets/img/register/register__1.png" alt="register">
                <img loading="lazy"  class="register__2" src="assets/img/register/register__2.png" alt="register">
                <img loading="lazy"  class="register__3" src="assets/img/register/register__3.png" alt="register">
            </div>
        </div>
        <!-- register__section__start-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="single__team">
                            <div class="teamarea__img">
                                <img loading="lazy"  src="assets/img/team/team__1.png" alt="team">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="single__team">
                            <div class="teamarea__img">
                                <img loading="lazy"  src="assets/img/team/team__2.png" alt="team">
                                <div class="teamarea__icon">
                                    <ul>
                                        <li>
                                            <a href="#"> <i class="icofont-facebook"></i></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-aos="fade-up">
                        <div class="single__team">
                            <div class="teamarea__img">
                                <img loading="lazy"  src="assets/img/team/team__3.png" alt="team">
                                <div class="teamarea__icon">
                                    <ul>
                                        <li>
                                            <a href="#"><i class="icofont-facebook"></i></a>
                ...
                <div class="row">
                            ...
                            <div class="testimonialarea__paragraph__3 ">
                                ...
                                <div class="testimonialarea__person__3">
                                    <div class="testimonial__img__3">
                                        <img loading="lazy"  src="assets/img/testimonial/testi_2.png" alt="">
                                    </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="testimonial__group__img" data-tilt>
                            <img loading="lazy"  src="assets/img/testimonial/testi__group__1.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                        <div class="single__blog__wraper">
                            <div class="single__blog__img">
                                <img loading="lazy"  src="assets/img/blog/blog_5.png" alt="blog">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                        <div class="single__blog__wraper">
                            <div class="single__blog__img">
                                <img loading="lazy"  src="assets/img/blog/blog_24.png" alt="blog">
                                <div class="single__blog__button">
                                    <a class="default__button" href="#">Story</a>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                        <div class="single__blog__wraper">
                            <div class="single__blog__img">
                                <img loading="lazy"  src="assets/img/blog/blog_25.png" alt="blog">
                                <div class="single__blog__button">
                                    <a class="default__button" href="#">Story</a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3">
                            <div class="copyright__logo">
                                <a href="/"><img loading="lazy"  src="assets/img/logo/logo_2.png" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
