...
<head>
    ...
    <title>Home-9 Kindergarten Dark | Edurock - Education LMS Template</title>
                ...
                <div class="herobannerarea__slider__wrap swiper-wrapper">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12" data-aos="fade-up">
									<div class="herobanner__video registerarea__video">
										<img loading="lazy"  src="img/herobanner/herobanner__slider__5.png" alt="Video Banner">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__img">
                                    <img loading="lazy"  src="img/herobanner/herobanner__slider__6.png" alt="">
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="swiper-slide herobannerarea__single__slider">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12" data-aos="fade-up">
                                <div class="herobannerarea__img">
                                    <img loading="lazy"  src="img/herobanner/herobanner__slider__7.png" alt="">
                                </div>
                            </div>
                        </div>
                        </div>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="about__right__wraper__2">
                            <div class="educationarea__img" data-tilt>
                                ...
                                <img loading="lazy"  class="aboutarea__2__img__2" src="img/about/about_19.png" alt="education">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        ...
                        <div class="aboutarea__content__wraper">
                            ...
                            <div class="aboutarea__headding heading__underline">
                                <h2>Welcome to the <span>Kids</span> Learning Center</h2>
                            </div>
				...
				<div class="row">
					<div class="section__title text-center" data-aos="fade-up">
						<div class="section__title__button">
							<div class="default__small__button">Programs</div>
						</div>
						<div class="section__title__heading heading__underline">
							<h2>Early learning <span>Programs</span>
								<br> For Your Baby.</h2>
						</div>
					</div>
				</div>
					...
					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
						<div class="single__blog__wraper">
							<div class="single__blog__img">
								<img loading="lazy"  src="img/program/kids_1.png" alt="blog">
							</div>
							<div class="single__blog__content">
								<p>2-3 Years</p>
								<h4> <a href="#">Play Group</a></h4>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 about__wrap__content" data-aos="fade-up">
                        ...
                        <div class="populerarea__content__wraper__2">
                            <div class="section__title ">
                                <div class="section__title__button">
                                    <div class="default__small__button">Populer Folmulas</div>
                                </div>
                                <div class="section__title__heading">
                                    <h2>Making your child’s with 
                                        <br>world’s better folmulas.</h2>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service">
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.php">Daily Routnies</a></h3>
                                ...
                                <rect x="28" y="11.5198" width="8" height="0.993319" fill="#FFB31F"/>
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.php">Toy & Games</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="#">View Subject
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12" data-aos="fade-up">
                                <div class="single__service ss_margin">
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.php">Activity Room</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="#">View Subject
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M26.9989 7.6293L23.05 18.137L20.3744 15.4678C15.622 19.6266 9.96272 22.5976 3.63238 24.2568C1.36694 24.9297 0.353173 21.6176 2.74495 21.0505C8.47735 19.533 13.5443 16.8156 17.8363 13.1279L15.5453 10.8879L26.9989 7.6293Z" fill="#FFB31F"/>
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M63.3775 44.4535C54.8582 58.717 39.1005 53.2202 23.1736 47.5697C7.2467 41.9192 -5.18037 32.7111 3.33895 18.4477C11.8583 4.18418 31.6595 -2.79441 47.5803 2.85105C63.5011 8.49652 71.8609 30.2313 63.3488 44.4865L63.3775 44.4535Z" fill="#5F2DED" fill-opacity="0.05"/>
                                    ...
                                    <div class="service__content service__content__2">
                                        <h3><a href="course-details.php">Summer Champ</a></h3>
                                        <p>Construction is a general term the art and science to form </p>
                                    </div>
                                    <div class="service__button">
                                        <a href="#">View Subject
            ...
            <div class="container">
                <div class="row">
                    <div class="section__title text-center" data-aos="fade-up">
                        ...
                        <div class="section__title__heading heading__underline">
                            <h2>Perfect Kindergarten <span>Overview</span>
                                <br> For Your Kids.</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-content tab__content__wrapper" id="myTabContent" data-aos="fade-up">
                            ...
                            <div class="col-xl-12">
                                <div class="aboutarea__content__tap__wraper">
                                    <p class="paragraph__1">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words look even slightly believable. If you are going to use
                                        ...
                                        <img loading="lazy"  src="img/about/overview_kg.png" alt="">
                                </div>
                        ...
                        <div class="tab-pane fade" id="projects__two" role="tabpanel" aria-labelledby="projects__two">
                            ...
                            <div class="col-xl-12">
                                <div class="aboutarea__content__tap__wraper">
                                    <p class="paragraph__1">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words look even slightly believable. If you are going to use
                                        a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. Ipsum generators on the Internet tend to repeat predefined chunks as necessary.</p>
                                    ...
                                    <img loading="lazy"  src="img/about/mission.jpg" alt="Mission">
                                </div>
                        ...
                        <div class="tab-pane fade" id="projects__three" role="tabpanel" aria-labelledby="projects__three">
                            <div class="col-xl-12">
                                <div class="aboutarea__content__tap__wraper">
                                    <p class="paragraph__1">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. Ipsum generators on the Internet tend to repeat predefined chunks as necessary. Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus quae rerum dolore itaque tenetur. Natus illum nostrum, deleniti ipsa animi accusantium quos placeat eaque. </p>
                                    <div class="aboutarea__list__2">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            <ul>
                                    ...
                                    <img loading="lazy"  src="img/about/vision.jpg" alt="Mission">
                                </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                ...
                                                <div class="eventarea__content__wraper">
                                                    <div class="single__event__heading">
                                                        <h4><a href="event-details.php">Forging relationships between national</a></h4>
                                                    </div>
                                                    <div class="single__event__button">
                                                        <a href="event-details.php">Read More <i class="icofont-simple-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                            <div class="single__event__wraper single__award" data-aos="fade-up">
                                                ...
                                                <div class="eventarea__content__wraper">
                                                    <div class="single__event__heading">
                                                        <h4><a href="event-details.php">Lorem ipsum dolor sit amet conse ctetur.</a></h4>
                                                    </div>
                                                    <div class="single__event__button">
                                                        <a href="event-details.php">Read More <i class="icofont-simple-right"></i></a>
                                                    </div>
                    ...
                    <div class="swiper featured__course">
                        <div class="swiper-wrapper">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/grid/kid_2.jpg" alt="grid"></a>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/grid/kid_5.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12 grid-item column__custom__class swiper-slide">
                                <div class="gridarea__wraper">
                                    <div class="gridarea__img">
                                        <a href="course-details.php"><img loading="lazy"  src="img/grid/kid_6.jpg" alt="grid"></a>
                                        <div class="gridarea__small__button gridarea__small__button__1">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8" data-aos="fade-up">
                        <div class="blogarea__content__wraper">
                            <div class="blogarea__img">
                                <img loading="lazy"  src="img/blog/blog_31.jpg" alt="blog">
                    ...
                    <div class="col-xl-4 col-lg-4" data-aos="fade-up">
                        <div class="blogarea__content__wraper">
                            <div class="blogarea__img">
                                <img loading="lazy"  src="img/blog/blog_32.jpg" alt="blog">
                        ...
                        <div class="blogarea__content__wraper">
                            <div class="blogarea__img">
                                <img loading="lazy"  src="img/blog/blog_33.jpg" alt="blog">
                                <div class="blogarea__date small__date">
                                    20
                                    <span>Oct</span>
                                </div>
