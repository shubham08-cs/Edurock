...
<head>
    ...
    <title>Course Details 3 Dark| Edurock - Education LMS Template</title>
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="scc__wrap">
                                                            ...
                                                            <div class="scc__meta">
                                                                ...
                                                                <a href="lesson.php"><span><i class="icofont-lock"></i></span></a>
                                                            </div>
                                                        </div>
                                                        <div class="scc__wrap">
                                                            <div class="scc__info">
                                    ...
                                    <div class="tab-pane fade active show" id="projects__three" role="tabpanel" aria-labelledby="projects__three">
                                        ...
                                        <div class="property__facts__feature property__facts__feature__2 ">
                                            ...
                                            <ul class="property__comment">
                                                ...
                                                <li class="property__comment__list">
                                                    <div class="property__comment__img">
                                                        <img loading="lazy"  src="img/teacher/teacher__1.png" alt="Image">
                                                    </div>
                                                    <div class="property__comment__comment">
                                                        <h6><a href="#">Adam Smit</a></h6>
                                                        <div class="property__sidebar__icon">
                                                ...
                                                <li class="property__comment__list">
                                                    <div class="property__comment__img">
                                                        <img loading="lazy"  src="img/teacher/teacher__3.png" alt="Image">
                                                    </div>
                                                    <div class="property__comment__comment">
                                                        <h6><a href="#">Adam Smit</a></h6>
                                                        <div class="property__sidebar__icon">
                        ...
                        <div class="course__details__sidebar--2">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="course__summery__item">
                                                <span class="sb_label">Instructor:</span><span class="sb_content"><a href="instructor-details.php">D. Willaim</a></span>
                                            </div>
                                        </li>
                            ...
                            <div class="blogsidebar__content__wraper__2" data-aos="fade-up">
                                ...
                                <div class="get__touch__input">
                                    ...
                                    <a class="default__button" href="blog-details.php">SEND MASSAGE</a>
                                </div>
                            ...
                            <div class="blogsidebar__content__wraper__2" data-aos="fade-up">
                                ...
                                <div class="populer__tag__list">
                                    <ul>
                                        ...
                                        <li><a href="blog-details.php">apps</a></li>
                                        <li><a href="blog-details.php">landing page</a></li>
                                        <li><a href="blog-details.php">data</a></li>
                                        <li><a href="blog-details.php">book</a></li>
                                        <li><a href="blog-details.php">Design</a></li>
                                        <li><a href="blog-details.php">book</a></li>
                                        <li><a href="blog-details.php">landing page</a></li>
                                        <li><a href="blog-details.php">data</a></li>
